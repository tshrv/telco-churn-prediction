...
5. Confusion Matrix ![Constrained model confusion matrix](docs/final-model-confusion-matrix.png)
   ```
...
1. Feature importance ![Feature importance](docs/feature-importance.png)
...
3. Decision Tree visualization and interpretation
   1. ![Decision tree visualization](docs/final-model-dt-visualization.png)
